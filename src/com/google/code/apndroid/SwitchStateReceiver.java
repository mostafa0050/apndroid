...
/**
 * Broadcast receiver that performs switching current apn state and performs notification about this sending
...
public class SwitchStateReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (ApplicationConstants.APN_DROID_CHANGE_STATUS.equals(intent.getAction())){
            ...
            MessagingUtils.sendStatusMessage(context, currentState, true);
        }
    }
}
