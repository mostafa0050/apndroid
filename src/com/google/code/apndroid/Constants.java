...
public final class Constants {
    ...
    /**
     * Intent name for binding to the apndroid service
     */
    public static final String ACTION_SERVICE = "com.google.code.apndroid.intent.action.SERVICE";
    ...
    // todo replace in project default placeholders
    public static final int DEFAULT_CONNECTION_STATE = STATE_ON;
    public static final int DEFAULT_MMS_STATE = STATE_ON;
     ...
     * Common log tag
     */
    public static final String APP_LOG = "apndroid.log";
}
